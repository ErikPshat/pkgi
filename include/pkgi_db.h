...
typedef enum {
    ...
    DbFilterContentTuning	= 0x040000,
    ...
    DbFilterAllContent = DbFilterContentGame | DbFilterContentRUS | DbFilterContentPS2 | DbFilterContentPS1 | DbFilterContentMinis | DbFilterContentDLC | DbFilterContentTheme | DbFilterContentAvatar | DbFilterContentDemo | DbFilterContentApp | DbFilterContentTuning | DbFilterContentCheat | DbFilterContentUpdate,
